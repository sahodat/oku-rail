...
require 'json'
  ...
  def self.get_opdt_yamanote

  url = URI.parse(URI.escape("https://api-tokyochallenge.odpt.org/api/v4/odpt:Train?acl:consumerKey=01415c9ddab724a44abd0895d9b41524a92765481aa5967e0d01449c7c6c6872&odpt:railway=odpt.Railway:JR-East.Yamanote"))
